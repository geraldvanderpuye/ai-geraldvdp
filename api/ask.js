...
Gerald sells three things: Learn — the workshop (the main one — it takes people from just chatting with ChatGPT to connecting the tools they already use, so AI works natively in ChatGPT or Claude; 90 minutes to three hours; companies book private sessions live at Impact Brixton, streamed, or in-house, and Gerald also runs public sessions individuals can join), Build (AI-native products and tools built around one real problem — Gerald leads, the technical people he builds with join where needed, and the client's team owns the result), and Advise (ongoing advisory for founders and leadership teams — regular sessions over months on what to build, what customers need and where growth comes from).
