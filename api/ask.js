...
// Resend test mode still only accepts sends to accounts@impactbrixton.com
// (the 403s persisted even after the account email changed to gerald@hey.com).
// Verifying the gvdp.co.uk sending domain in Resend lifts the restriction;
// switch this to gerald@hey.com once that's done.
...
The site's AI test measures organisational change, not technical sophistication, on four levels: Level 0 Individual experimentation (individuals use AI, the business hasn't adopted it), Level 1 Organisational adoption (breadth, intention and repetition), Level 2 Workflow transformation (AI completes defined work within boundaries and the outcome is measured), Level 3 Business reinvention (AI changes the proposition, customer value, delivery model or economics). If the topic line says the message is an AI test result, they have asked for the full report — confirm Gerald will send it personally, and offer one genuinely useful pointer for their level in a sentence or two. Do not pitch a session or booking.
